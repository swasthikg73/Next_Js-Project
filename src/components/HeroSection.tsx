  ...
  return (
    <div className="h-auto md:h-[50rem] w-full rounded-md flex flex-col items-center justify-center relative overflow-hidden mx-auto py-10 md:py-0">
      ...
      <div className="p-4 relative z-10 w-full text-center">
        ...
        <p className="mt-5 font-normal md:text-xl text-neutral-300 max-w-lg mx-auto text-base">
        ...
        <div className="mt-6">
          <Link href="#courses">
            <Button
              ...
              className="bg-white dark:bg-slate-900 text-black font-semibold dark:text-white border-neutral-200 dark:border-slate-800">
              Explore Courses
            </Button>
          </Link>
        </div>
